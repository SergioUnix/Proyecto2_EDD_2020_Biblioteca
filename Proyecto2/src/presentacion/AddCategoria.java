...
public class AddCategoria extends javax.swing.JFrame {
   ...
   private int y; 
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 30, 330, 60));
        ...
        jButton1.setFont(new java.awt.Font("Dosis", 1, 18)); // NOI18N
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 260, 190, 40));
        ...
        getContentPane().add(categoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 180, 220, 30));

        jLabel4.setBackground(new java.awt.Color(0, 0, 0));
        jLabel4.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Reporte de Categorias");
        jLabel4.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel4MouseClicked(evt);
            }
        });
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 430, -1, -1));
        ...
        getContentPane().add(lblsalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(551, 16, 60, 50));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/fondoCategoria.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!categoria.getText().equals("")&& presentacion.Login.logueado.getAVL().exist(categoria.getText())==false){
        presentacion.Login.logueado.getAVL().insertar_avl(categoria.getText());
        JOptionPane.showMessageDialog(null, "Categoria Guardada");
        categoria.setText("");
        
        }else{ JOptionPane.showMessageDialog(null, "Categoria ya existe o el campo esta vacio");}
